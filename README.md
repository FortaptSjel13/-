...
## Цель проекта:
Построить витрину данных, предназначенную для анализа транзакций мобильного платёжного сервиса и оценки мошеннической активности.
Витрина должна выявлять пиковые периоды нагрузки, анализировать распределение фрода по типам операций и времени, а также сравнивать реальные и зафлагированные мошеннические транзакции для оценки эффективности антифрод-систем.
